...
module.exports = {
    ...
    async register_restaurant (req, res, next) {
        try {
            ...
            await Rol.create(data.id, 2); // ROL POR  (restaurant)
    ...
    async register_delivery (req, res, next) {
        try {
            ...
            await Rol.create(data.id, 3); // ROL POR  (delivery)
